...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/richnstore/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
akbarvpnn="raw.githubusercontent.com/richnstore/scriptvps/main/xray"

# Link Hosting Kalian Untuk Trojan Go
akbarvpnnn="raw.githubusercontent.com/richnstore/scriptvps/main/trojango"

# Link Hosting Kalian Untuk Stunnel5
akbarvpnnnn="raw.githubusercontent.com/richnstore/scriptvps/main/stunnel5"
...
state=Indonesia
locality=Indonesia
organization=richnarendrastore
organizationalunit=richnarendrastore
commonname=richnarendrastore
